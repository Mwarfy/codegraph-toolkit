...
echo ""
echo "# 1. salsa first (no @liby/ deps)"
echo "  npm publish --workspace=@liby/salsa"
echo ""
echo "# 2. datalog (no @liby/ deps)"
echo "  npm publish --workspace=@liby/datalog"
echo ""
echo "# 3. codegraph (depends on @liby/salsa)"
echo "  npm publish --workspace=@liby/codegraph"
echo ""
echo "# 4. adr-toolkit (depends on @liby/codegraph + @liby/datalog)"
echo "  npm publish --workspace=@liby/adr-toolkit"
echo ""
echo "# 5. codegraph-mcp (depends on @modelcontextprotocol/sdk)"
echo "  npm publish --workspace=@liby/codegraph-mcp"
echo ""
echo "─── 8. Post-publish ──────────────────────────────────────────"
echo ""
echo "After publish, consumers can install via :"
echo "  npm install @liby/codegraph @liby/adr-toolkit @liby/codegraph-mcp"
echo ""
