...
| [006](006-core-types-canonical-contract.md) | `packages/codegraph/src/core/types.ts` est importé par 57+ fichiers (top hub absolu du toolkit). Tout type ... | `packages/codegraph/src/check/types.ts`, `packages/codegraph/src/core/framework-conventions.ts` +3 |
