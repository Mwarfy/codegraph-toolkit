...
| [024](024-bsp-monoid-parallelism.md) | Tout détecteur per-file (cf. ADR-005) DOIT exposer un `extractFileBundle` pure et son orchestrateur passe p... | `packages/codegraph/src/extractors/todos.worker.ts`, `packages/codegraph/src/parallel/bsp-scheduler.ts` +4 |
