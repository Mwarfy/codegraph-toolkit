...
| [007](007-salsa-incremental-contracts.md) | `incremental/queries.ts` et `incremental/database.ts` sont les **points d'entrée canoniques** pour toute co... | `packages/codegraph/src/incremental/barrels.ts`, `packages/codegraph/src/incremental/co-change.ts` +29 |
