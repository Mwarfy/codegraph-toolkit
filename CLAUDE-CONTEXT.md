...
- `packages/codegraph/src/core/types.ts` (in: 52)
- `packages/salsa/dist/index.d.ts` (in: 10)
- `packages/adr-toolkit/src/config.ts` (in: 9) · gov by ADR-002
- `packages/codegraph/src/incremental/database.ts` (in: 9)
- `packages/codegraph/src/incremental/queries.ts` (in: 9)
...
- **52** `packages/codegraph/src/core/types.ts` _(top-hub)_
